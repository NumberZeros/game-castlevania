...
void LoadResources()
{
	...
	// big
	sprites->Add(10001, 246, 394, 260, 421, texMario);		// idle right

	sprites->Add(10002, 275, 394, 290, 421, texMario);		// walk
	sprites->Add(10003, 304, 394, 321, 421, texMario);

	sprites->Add(10011, 186, 394, 200, 421, texMario);		// idle left
	sprites->Add(10012, 155, 394, 170, 421, texMario);		// walk
	sprites->Add(10013, 125, 394, 140, 421, texMario);
...
void Update(DWORD dt)
{
	...
	for (int i = 1; i < objects.size(); i++) // i bằng 1 do mario == 0
	{
